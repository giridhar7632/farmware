    ...
    <div className="flex flex-col min-h-[100dvh]">
      ...
      <main className="flex-1">
              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-neutral-500 md:text-xl dark:text-neutral-400">
                    Analysis your farm for the soil moisture, nutrients and get recommended about the high yeilding crops all by satellite images
                  </p>
                </div>
        ...
        <section className="w-full py-12 md:py-24 lg:py-32">
          <div className="container grid max-w-5xl items-center gap-6 px-4 md:px-6 py-12 lg:grid-cols-2 lg:gap-12">
            <Image
              alt="Image"
              ...
              <ul className="grid gap-6">
                ...
                <li>
                  <div className="grid gap-1">
                    ...
                    <p className="text-neutral-500 dark:text-neutral-400">
                      See your farm analysis by or powerful algorithms in minutes.
                    </p>
                  </div>
                </li>
              </ul>
          ...
          <div className="container grid items-center justify-center gap-6 px-4 md:px-6 lg:grid-cols-2 lg:gap-10">
            <div className="space-y-2">
              ...
              <p className="mx-auto max-w-[600px] text-neutral-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-neutral-400">
                Get the most out of your land using our analysis and suggestions based on your soil moisture and nutirent levels.
              </p>
            </div>
            <div className="flex space-x-4 lg:justify-end">
              <Link
                className="inline-flex h-10 items-center justify-center rounded-md bg-neutral-900 px-8 text-sm font-medium text-neutral-50 shadow transition-colors hover:bg-neutral-900/90 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-neutral-950 disabled:pointer-events_none disabled:opacity-50 dark:bg-neutral-50 dark:text-neutral-900 dark:hover:bg-neutral-50/90 dark:focus-visible:ring-neutral-300"
                href="#"
              >
                Get started
              </Link>
